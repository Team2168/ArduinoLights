...
void arrows_right() {
  ...
  leds[44 - (i + 3) % 23] = CRGB::Green;
  leds[1 + (i + 3 - 2 - modular) % 22] = CRGB::Green;
  leds[44 - (i + 4) % 23] = CRGB::Green;

  leds[45 + (i + 6) % 23] = CRGB::Blue;
  leds[44 - (i + 6) % 23] = CRGB::Blue;
  leds[1 + (i + 6 - 2 - modular) % 22] = CRGB::Blue;
  leds[44 - (i + 7) % 23] = CRGB::Blue;
  ...
  if(timeElapsedGreaterThanEqualNumber) {
    ...
    leds[44 - (i + 3) % 23] = CRGB::Black;
    leds[1 + (i + 3 - 2 - modular) % 22] = CRGB::Black;
    leds[44 - (i + 4) % 23] = CRGB::Black;

    leds[45 + (i + 6) % 23] = CRGB::Black;
    leds[44 - (i + 6) % 23] = CRGB::Black;
    leds[1 + (i + 6 - 2 - modular) % 22] = CRGB::Black;
    leds[44 - (i + 7) % 23] = CRGB::Black;
...
void arrows_left() {
  ...
  leds[68 - (i + 3 + 2) % 23] = CRGB::Green;
  leds[23 + (i + 3) % 23] = CRGB::Green;
  leds[22 - (i + 3 + 2) % modular] = CRGB::Green;
  leds[23 + (i + 4) % 23] = CRGB::Green;

  leds[68 - (i + 6 + 2) % 23] = CRGB::Blue;
  leds[23 + (i + 6) % 23] = CRGB::Blue;
  leds[22 - (i + 6 + 2) % modular] = CRGB::Blue;
  ...
  if(timeElapsedGreaterThanEqualNumber) {
    ...
    leds[68 - (i + 3 + 2) % 23] = CRGB::Black;
    leds[23 + (i + 3) % 23] = CRGB::Black;
    leds[22 - (i + 3 + 2) % modular] = CRGB::Black;
    leds[23 + (i + 4) % 23] = CRGB::Black;
  
    leds[68 - (i + 6 + 2) % 23] = CRGB::Black;
    leds[23 + (i + 6) % 23] = CRGB::Black;
    leds[22 - (i + 6 + 2) % modular] = CRGB::Black;
...
void intake_cube(CRGB robotColor) {
  ...
  leds[animation[intakePatternCounter][0]-1] = robotColor;
  leds[animation[intakePatternCounter][1]-1] = robotColor;
  leds[animation[intakePatternCounter][2]-1] = robotColor;
  leds[animation[intakePatternCounter][3]-1] = robotColor;
  leds[animation[intakePatternCounter][4]-1] = robotColor;
  leds[animation[intakePatternCounter][5]-1] = robotColor;
  leds[animation[intakePatternCounter][6]-1] = robotColor;
  leds[animation[intakePatternCounter][7]-1] = robotColor;
  leds[animation[intakePatternCounter][8]-1] = CRGB::Yellow;
  delay(30);
  FastLED.show();
